...
/**
* Interface describing `nanstdevpn`.
*/
interface Routine {
	/**
	...
	*/
	...
	/**
	* Computes the standard deviation of a strided array ignoring `NaN` values and using a two-pass algorithm and alternative indexing semantics.
	*
	* @param N - number of indexed elements
	* @param correction - degrees of freedom adjustment
	* @param x - input array
...
* // returns ~2.0817
*/
declare var nanstdevpn: Routine;
